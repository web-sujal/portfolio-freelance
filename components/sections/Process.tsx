      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16">
          <div>
            <div className="sticky top-32">
              ...
              <div className="mt-12 hidden lg:block">
                ...
                >
                  {processData.cta} <ArrowRightIcon weight="bold" aria-hidden />
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-0 relative">
            <motion.div
              className="absolute left-4 sm:left-6 top-6 bottom-6 w-px bg-gradient-to-b from-indigo-500 via-purple-500 to-transparent origin-top"
