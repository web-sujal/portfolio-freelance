    ...
    >
      ...
      >
        ...
        <div>
          <div className="w-14 h-14 bg-purple-500/10 rounded-2xl flex items-center justify-center text-purple-400 mb-6 group-hover:scale-110 transition-transform">
            <LightningIcon weight="duotone" className="text-3xl" aria-hidden />
          </div>
      ...
      >
        <div className="w-14 h-14 bg-emerald-500/10 rounded-2xl flex items-center justify-center text-emerald-400 mb-6 group-hover:scale-110 transition-transform">
          <HardDrivesIcon weight="duotone" className="text-3xl" aria-hidden />
        </div>
        <h3 className="text-xl font-bold text-white mb-3">
      ...
      <motion.div
        variants={cardVariants}
        className="md:col-span-2 bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-3xl p-8 border border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden text-center md:text-left"
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-indigo-200 text-sm">{services.cta.description}</p>
        </div>
        <Link
          href="#contact"
